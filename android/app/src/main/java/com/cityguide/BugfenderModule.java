...
public class BugfenderModule extends ReactContextBaseJavaModule {
    ...
    public void logWarning(String tag, String message) {
        Bugfender.log(0, "", "", LogLevel.Warning, tag, message);
    }

    @ReactMethod
    public void logError(String tag, String message) {
        Bugfender.log(0, "", "", LogLevel.Error, tag, message);
    }
    ...
    @ReactMethod
    public void getSessionIdentifier(Promise promise) {
        promise.resolve(Bugfender.getSessionIdentifier());
    }
    ...
    public void sendIssue(String title, String text, Promise promise) {
        promise.resolve(Bugfender.sendIssue(title, text).toString());
    }
